...
<footer id="footer" class="section section-grey">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/Ecodigipack.png" alt="">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Jual Berbagai Macam Kemasan Makanan Dan Custom Sesuai Permintaan.</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					<h3 class="footer-header">Ikuti Kami</h3>
					
					<p>Follow media sosial kami untuk lebih dekat dan mendapat informasi-informasi terbaru tentang toko kami.</p>
					
					<!-- footer social -->
					<ul class="footer-social">
						<li><a href="https://web.facebook.com/ecodigipack.ecodigipack.5"><i class="fa fa-facebook"></i></a></li>	
						<li><a href="https://www.instagram.com/ecodigipackaging/"><i class="fa fa-instagram"></i></a></li>
						<li><a href="https://shopee.co.id/ecodigipack"><i class="fa fa-shopping-cart"></i></a></li>
						<li><a href="https://api.whatsapp.com/send/?phone=%2B6282131996600&text&type=phone_number&app_absent=0"><i class="fa fa-whatsapp"></i></a></li>
					</ul>
					<!-- /footer social -->
				</div>
			</div>
